...
struct boundary_data_recv{
  int _id; Vector3d _force; Vector3d _moment;
  boundary_data_recv(){
    _id = -1; _force << 0.,0.,0.; _moment << 0.,0.,0.;
  }
  ...
  boundary_data_recv(const boundary_data_recv & other){
    _id = other._id; _force = other._force; _moment = other._moment;
  }
  boundary_data_recv& operator=(const boundary_data_recv & other){
    _id = other._id; _force = other._force; _moment = other._moment; return *this;
  }
};
