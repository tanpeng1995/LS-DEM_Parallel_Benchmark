...
std::unique_ptr<Grain3d> regenerateGrainFromFile(const Vector3d & position, const Vector4d & quat, const Vector3d & velocity, const Vector3d & omega, const string & morphfile, int grainidx) {
