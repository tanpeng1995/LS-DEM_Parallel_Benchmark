...
int main(int argc, char* argv[]) {
  ...
  string parametersdir = "/global/home/users/tanpeng/LSDEM_Settle/Parameters_LSDEM.txt";
  ...
  if (rank == 0){
    ...
    cout<<"Settle down, gravity: "<<gravity<<endl;
    cout<<"Output Directory: "<<outdir<<endl<<endl;
  }
