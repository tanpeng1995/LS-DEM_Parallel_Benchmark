      ...
      for(int iy = 0; iy < Ny; ++iy){
        for(int ix = 0; ix < Nx; ++ix){
          ...
          for(int i = 0; i < target_grains; ++i){
            ...
            if(_proc_id == rank){
              grainsWorld[gid] = generateGrainFromFile(inputPos[gid], inputRot[gid], morphfile.str(), grainDensity, gid);
              ...
              grainsWorld[gid] = generateSimpleGrain3d(inputPos[gid], inputRot[gid], morphfile.str(), grainDensity, gid);
