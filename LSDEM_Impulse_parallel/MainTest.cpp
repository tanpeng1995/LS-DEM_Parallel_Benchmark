...
int main(int argc, char* argv[]) {
  ...
  string parametersdir = "/global/home/users/tanpeng/LSDEM_Impulse_parallel/Parameters_LSDEM.txt";
  readParametersTrueUnit(parametersdir);
  string indir = "/global/scratch/users/tanpeng/LSDEM_Modelling/Input/"+testName+"/";
  string outdir = "/global/scratch/users/tanpeng/LSDEM_Modelling/Output/"+testName+"_3/";
  ...
  if (rank == 0){
    ...
    if(massScaling) cout<<"For mass scaling, minMass: "<<minMass<<" maxMass: "<<maxMass<<endl;
